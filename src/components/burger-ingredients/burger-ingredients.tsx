...
export const BurgerIngredients: FC = () => {
  ...
  const buns: TIngredient[] = ingredients.filter((ingredient) => ingredient.type === 'bun');
  const mains: TIngredient[] = ingredients.filter((ingredient) => ingredient.type === 'main');
  const sauces: TIngredient[] = ingredients.filter((ingredient) => ingredient.type === 'sauce');
